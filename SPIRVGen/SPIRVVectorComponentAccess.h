...
void X(const vec_type_t<base_type_t<T>, 1>& _var) const { InsertComponent<1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
__declspec(property(get = X, put = X)) TExtractType<1> x;
__declspec(property(get = X, put = X)) TExtractType<1> r;
#endif // !SPEAR_ENABLE_PROPERTIES
...
void XX(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XXWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 0, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XY(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XYWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 1, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZ(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XZWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 2, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XW(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 0, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void XWWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 0, 3, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void Y(const vec_type_t<base_type_t<T>, 1>& _var) const { InsertComponent<1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YX(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YXWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 0, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YY(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YYWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 1, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZ(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YZWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 2, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YW(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 1, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void YWWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 1, 3, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void Z(const vec_type_t<base_type_t<T>, 1>& _var) const { InsertComponent<1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZX(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZXWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 0, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZY(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZYWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 1, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZ(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZZWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 2, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZW(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 2, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void ZWWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 2, 3, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void W(const vec_type_t<base_type_t<T>, 1>& _var) const { InsertComponent<1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WX(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WXWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 0, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WY(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WYWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 1, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZ(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WZWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 2, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WW(const vec_type_t<base_type_t<T>, 2>& _var) const { InsertComponent<2, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWX(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWXX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 0, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWXY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 0, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWXZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 0, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWXW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 0, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWY(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWYX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 1, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWYY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 1, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWYZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 1, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWYW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 1, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWZ(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWZX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 2, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWZY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 2, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWZZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 2, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWZW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 2, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWW(const vec_type_t<base_type_t<T>, 3>& _var) const { InsertComponent<3, 3, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWWX(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 3, 0>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWWY(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 3, 1>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWWZ(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 3, 2>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
...
void WWWW(const vec_type_t<base_type_t<T>, 4>& _var) const { InsertComponent<3, 3, 3, 3, 3>(make_const<Assemble>(_var));}
#ifdef SPEAR_ENABLE_PROPERTIES
